...
OUTPUT_PATH = "output_v12.mp4"
PREDICTION_FILE_PATH = "predictions_v12.txt"
...
GATE_SIZE_AIR = 150.0
MAX_LOST_FRAMES = 20 # Increased slightly to give the physics model time to work
...
# --- V12: New Physics-Aware Kalman Filter ---
...
class VideoProcessor:
    ...
    def run(self):
                ...
                if measurement_abs is not None:
                    ...
                    if not self.track_initialized:
                        ...
                        if self.ball_state == BallState.ON_GROUND:
                            ...
                            if is_point_in_action_zones(ball_pos_rel, player_detections.xyxy) and instant_velocity[1] < UPWARD_VELOCITY_THRESHOLD:
                                self.ball_state = BallState.IN_AIR
                                is_kick = True
                        if is_kick:
                    ...
                    if self.lost_frames_count > MAX_LOST_FRAMES:
                        ...
                        # BUG FIX: Reshape the 1D predicted_pos_abs to a 2D array for the function call
        ...
        out_writer.release()
        print("Processing complete for V12 (Corrected).")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="V12 (Corrected): Ball tracking with Physics-Aware Kalman Filter.")
