...
IMAGE_DIR_PATH = "img1"
OUTPUT_PATH = "output_v17_62.mp4"
PREDICTION_FILE_PATH = "predictions_v17_6.txt"
STATES_FILE_PATH = "states_v17_6.txt"
BALL_CONFIDENCE = 0.8
...
UPWARD_VELOCITY_SHOT_THRESHOLD = -25.0
...
class VideoProcessor:
    ...
    def run(self):
        ...
        out_writer.release()
        states_file.close()
        print("Processing complete for v17_6.")
