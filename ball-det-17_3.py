...
IMAGE_DIR_PATH = "img1"
OUTPUT_PATH = "output_v17_3.mp4"
PREDICTION_FILE_PATH = "predictions_v17_3.txt"
...
# --- V17_3: New State Detection Parameters ---
GROUND_CLEARANCE_PIXELS = 10
UPWARD_VELOCITY_CONTEXT_THRESHOLD = -5.0 


ACTION_ZONE_HEIGHT_PERCENT = 0.15
ACTION_ZONE_WIDTH_EXPANSION_PERCENT = 0.15

# --- V17_stable: State Confirmation Thresholds ---
GROUND_CONFIRMATION_THRESHOLD = 4
AIR_CONFIRMATION_THRESHOLD = 4
OCCLUDED_CONFIRMATION_THRESHOLD = 2

# --- V17 Player Occlusion Mode Parameters ---
OCCLUSION_ENTRY_THRESHOLD = 50.0 
MAX_OCCLUSION_FRAMES = 6 
MAX_LOST_FRAMES = 9
...
UPWARD_VELOCITY_SHOT_THRESHOLD = -30.0
...
class VideoProcessor:
    ...
    def _manage_state_transitions(self, measurement_abs, annotation_sv, predicted_pos_abs, player_detections, pitch_mask, coord_transform):
        ...
        if not has_measurement and find_nearby_player(pos_to_check, player_detections, OCCLUSION_ENTRY_THRESHOLD):
            is_lost_near_player = True
        
        # --- BUG FIX: Only perform checks that require a bbox if we have one ---
        if has_measurement and annotation_sv is not None:
            # V17_3: Ground Clearance Check
            ...
            if pitch_mask[check_y, center_x] == 255:
                is_on_ground = True

            # V17_3: Multi-Factor Kick Trigger evidence
    ...
    def run(self):
        # ... (This method logic remains the same as the user's provided script) ...
        # NOTE: I've copied the logic from the user's script for the main run loop.
        ...
        out_writer.release()
        print("Processing complete for V17 (Stable/Corrected).")
